...
static basic_sprite_t** get_player_shooting(void) {
    ...
    ret[0] = basic_sprite_ctor((const char *const *)survivor_shoot_rifle_0_xpm, 100, 0);
    ret[1] = basic_sprite_ctor((const char *const *)survivor_shoot_rifle_1_xpm, 100, 0);
    ret[2] = basic_sprite_ctor((const char *const *)survivor_shoot_rifle_2_xpm, 100, 0);
